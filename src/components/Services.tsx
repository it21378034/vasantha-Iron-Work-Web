...
export const Services: React.FC<ServicesProps> = ({ onSelectService }) => {
  const services = [
    ...
    },
    {
      ...
      features: ['Steel Roof Trusses', 'Industrial Canopy Framing', 'Carport & Shed Structures'],
    ...
    },
    {
      ...
      icon: Layers,
      image: '/images/ceiling_structure.jpg',
      description: 'Reliable metal ceiling frameworks ideal for modern commercial spaces and architectural design.',
      features: ['Metal Frame Ceilings', 'Exposed Industrial Beams', 'Custom Structural Support'],
    ...
    },
    {
      ...
      features: ['Custom Arc Welding', 'Architectural Metalwork', 'Heavy Structural Fabrication'],
